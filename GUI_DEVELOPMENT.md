...
controls use the same compatibility-preserving binding pattern.
...
and Apply preserve their existing engine behavior.
...
the v0.26 diagnostic `@gfx` code was removed from the GUI branch. Its
...
confirmed Last Touched behavior after this change. The complete interface was
then confirmed in REAPER before the v0.27 release.
